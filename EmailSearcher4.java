...
public class EmailSearcher4 {
	...
	public static void readOutlookEmail(String senderName, String fileDownloadPath, String host, String port,
		...
		properties.setProperty("mail.imaps.enableresponseevents", "true");
		properties.setProperty("mail.store.protocol", "imaps");

		properties.setProperty("mail.imaps.proxy.host", host);
		properties.setProperty("mail.imaps.proxy.port", port);
		properties.setProperty("mail.imaps.proxy.user", userEmail);
		properties.setProperty("mail.imaps.proxy.password", password);
	...
	public static void main(String[] args) throws GeneralSecurityException {
		...
		systemProps.put("javax.net.ssl.trustStore",
				"trustStorePath"); // Path of valid server trust store
		systemProps.put("javax.net.ssl.trustStorePassword", "password"); // Password of trust store
